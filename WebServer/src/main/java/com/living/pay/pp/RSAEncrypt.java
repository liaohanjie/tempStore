...
//		"MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA4t0c6WQhcygj9RbtsAAo" + "\r\n" +  
//		"uYz5JAsdFxSIpqNl3zNBvYB85yqvgrPdx47EFMGQTXwGWmqdStqAAtfUtd8cIfPm" + "\r\n" +  
//		"iajORPztSZhMPOtcbDa8OS5WAy1Id5bCzqYFF0Xm+7DudneMMo7DHD0onAHF0ibG" + "\r\n" +  
//		"ClVIsSZhw4BjJQZdR6sTbF8VaEWtQLuG4H7aJ8AVSRaR0Oet8Iz9sae3x6mbJuIj" + "\r\n" +  
//		"WLc35vmMLtM9CAFiIyKYwrmH2shNndNnvIqBtYZiqRTGO/au5cBc7m+1p4mi/CS5" + "\r\n" +  
//		"qrPs610Y1QLtVq59JKonSHIAuwvKXVvzicf6nL+3v6ck2yRnKbyDzZpQwoqfwWpW" + "\r\n" +  
//		"ZwIDAQAB" + "\r\n";
  
    public static final String DEFAULT_PUBLIC_KEY = PropertyUtils.SYS_CONFIG.get("sdk.pp.public.key");
    ...
    public void loadPublicKey(String publicKeyStr) throws Exception{  
        ...
        try {  
            ...
            byte[] buffer= base64Decoder.decode(publicKeyStr.getBytes("UTF-8")); 
    ...
    public static String decode(String input){
        ...
        try {  
            ...
            byte[] dcDataStr = base64.decode(input.getBytes());
