 ...
 * @date 2015年8月6日
 */
public class XyHandler extends ChannelHandler {

	private static final Logger logger = LoggerFactory.get(XyHandler.class);

	static final String AUTH_URL = PropertyUtils.SYS_CONFIG.get("sdk.xy.auth.url");
	
	static final String APP_ID = PropertyUtils.SYS_CONFIG.get("sdk.xy.app.id");
	
	static final String APP_KEY = PropertyUtils.SYS_CONFIG.get("sdk.xy.app.key");
	
	static final String PAY_KEY = PropertyUtils.SYS_CONFIG.get("sdk.xy.pay.key");
